...
if uploaded_files and st.sidebar.button("Process Documents"):
    if not sutra_api_key or not embedding_api_key:
        st.sidebar.error("Please enter both API keys before processing.")
    else:
...
if not st.session_state.documents_processed:
    ...
    if user_input:
        ...
        try:
            ...
            if "API key" in str(e):
                st.error("Please ensure your API keys are correct.")
